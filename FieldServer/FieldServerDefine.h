...
namespace Field
{
	class FieldServerDefine
    {
    public:
        static FieldServerDefine& Instance()
        {
            static FieldServerDefine instance;
            return instance;
        }
    ...
    private:
        // 복사 및 대입 방지
        FieldServerDefine() {}
        FieldServerDefine(const FieldServerDefine&) = delete;
        FieldServerDefine& operator=(const FieldServerDefine&) = delete;
