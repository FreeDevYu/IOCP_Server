...
namespace Manager
{
	int ServerManager::RegistMessageDispatcher()
	{
		...
		_messageDispatchers[protocol::MESSAGETYPE::MESSAGETYPE_REQUEST_REGISTER].ProtocolFunction = std::bind(&ServerManager::RESPONSE_REGISTER, this, std::placeholders::_1, std::placeholders::_2);
