...
namespace Manager
{
	...
	//Init
	void ServerManager::GetServerPort(std::vector<std::string> parameter)
	{
	...
	//Init
	void ServerManager::GetServerName(std::vector<std::string> parameter)
	{
	...
	void ServerManager::AddConnectPermissionIp(std::vector<std::string> parameter)
	{
